class PricingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @pricing.save
        format.html { redirect_to pricing_url(@pricing), notice: "Pricing was successfully created." }
  ...
  def update
    respond_to do |format|
      if @pricing.update(pricing_params)
        format.html { redirect_to pricing_url(@pricing), notice: "Pricing was successfully updated." }
  ...
  private
    ...
    def pricing_params
      params.require(:pricing).permit(:title, :description, :price)
    end
end
