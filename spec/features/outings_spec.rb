...
RSpec.describe 'Outings' do
  ...
  before do
    ...
    @past_outing = create(:outing, name: past_outing_name, creator_id: @outing_creator.id, date: 1.week.ago, description: past_outing_desc)
    @future_outing = create(:outing, creator_id: @outing_creator.id, name: 'future outing', date: 1.week.from_now)
    @another_outing = create(:outing, creator_id: @other_outing_creator.id, name: 'a better outing!', date: 1.week.from_now)
  ...
  context 'when a user is logged in' do
    ...
    describe 'user visit their account' do
      before do
        visit '/myaccount'
        @future_outings_element = find_by_id('future_outings')
